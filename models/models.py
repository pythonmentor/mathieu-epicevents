...
class Staff(Base):
    ...
    def __repr__(self) -> str:
        return (
            f"Staff(id={self.id!r}, name={self.name!r}, first_name={self.first_name!r})"
        )
...
class Client(Base):
    ...
    def __repr__(self) -> str:
        ...
        return f"Client(id:{self.id}, fullname : {self.fullname}, email : {self.email}, phone : {self.phone}, name_company : {self.name_company!r}, date_creation : {self.date_creation!r}, date_update : {self.date_update!r}, commercial_contact_id : {self.commercial_contact_id!r})"
